(function () {
  ...
  const CATEGORIES = [
    { key: "all", label: "전체", icon: "assets/icon_cat_all.svg", iconOn: "assets/icon_cat_all_active.svg" },
    { key: "voucher", label: "상품권", icon: "assets/icon_cat_coupon.svg", iconOn: "assets/icon_cat_coupon_active.svg" },
    { key: "cvs", label: "편의점", icon: "assets/icon_cat_store.svg", iconOn: "assets/icon_cat_store_active.svg" },
