(function () {
  ...
  const REWARDS = {
    available: [
      { name: "네이버페이 포인트 5,000원", cookies: 50, dday: "D-28", expiry: "~2026.05.21", thumb: "assets/naverpay_thumb.svg" },
      { name: "네이버페이 포인트 5,000원", cookies: 50, dday: "D-28", expiry: "~2026.05.21", thumb: "assets/naverpay_thumb.svg" },
    ],
    done: [
      { name: "네이버페이 포인트 5,000원", cookies: 50, expiry: "~2026.05.21", thumb: "assets/naverpay_thumb.svg" },
      { name: "네이버페이 포인트 5,000원", cookies: 50, expiry: "~2026.05.21", thumb: "assets/naverpay_thumb.svg" },
    ],
  };
  ...
  const cardHTML = (r, done) => `<div class="st-card${done ? " st-card--done" : ""}">
